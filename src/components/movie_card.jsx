const MovieCard = ({ movie }) => {
  ...
  return (
    <article className="group flex h-full w-full max-w-[220px] flex-col overflow-hidden rounded-xl border border-white/5 bg-[#1f1f1f] shadow-[0_18px_40px_rgba(0,0,0,0.22)] transition-all duration-200 hover:-translate-y-1 hover:border-white/10 hover:bg-[#2a2a2a]">
